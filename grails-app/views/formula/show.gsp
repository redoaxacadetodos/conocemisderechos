...
<g:set var="entityName"
	value="${message(code: 'formula.label', default: 'Formula')}" />
<title><g:message code="default.show.label" args="[entityName]" /></title>
</head>
<body>
	<a href="#show-formula" class="skip" tabindex="-1"><g:message
			...
			<g:if test="${formulaInstance?.nombre}">
				<li class="fieldcontain"><span id="nombre-label"
					class="property-label"><g:message
							code="formula.nombre.label" default="Nombre" /></span> <span
					class="property-value" aria-labelledby="nombre-label"><g:fieldValue
							bean="${formulaInstance}" field="nombre" /></span></li>
			</g:if>

			<g:if test="${formulaInstance?.descripcion}">
				<li class="fieldcontain"><span id="descripcion-label"
					class="property-label"><g:message
							code="formula.descripcion.label" default="Descripcion" /></span> <span
					class="property-value" aria-labelledby="descripcion-label"><g:fieldValue
							bean="${formulaInstance}" field="descripcion" /></span></li>
			</g:if>

			<g:if test="${formulaInstance?.sentencia}">
				<li class="fieldcontain"><span id="sentencia-label"
					class="property-label"><g:message
							code="formula.sentencia.label" default="Sentencia" /></span> <span
					class="property-value" aria-labelledby="sentencia-label"><g:fieldValue
							bean="${formulaInstance}" field="sentencia" /></span></li>
			</g:if>

			<g:if test="${formulaInstance?.numVariables}">
				<li class="fieldcontain"><span id="numVariables-label"
					class="property-label"><g:message
							code="formula.numVariables.label" default="Numero de  Variables" /></span>

					<span class="property-value" aria-labelledby="numVariables-label"><g:fieldValue
							bean="${formulaInstance}" field="numVariables" /></span></li>
			</g:if>
