...
<html>
	...
	<body>
		<a href="#edit-logotipo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-logotipo" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${logotipoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${logotipoInstance}" var="error">
			...
			<g:form method="post" class="uk-form uk-form-horizontal" enctype="multipart/form-data">
				...
				<g:hiddenField name="version" value="${logotipoInstance?.version}" />
				<fieldset class="form">
