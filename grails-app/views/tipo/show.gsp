...
<nav class="uk-navbar">
	...
	<fieldset class="uk-form-horizontal">
					...
					<g:link class="edit uk-button" action="edit" id="${tipoInstance?.id}"><i class="uk-icon-small uk-icon-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
