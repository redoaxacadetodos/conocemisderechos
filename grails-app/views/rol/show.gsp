		...
		<div id="show-rol" class="content scaffold-show" role="main">
			...
			<ol class="property-list rol">
				...
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="mx.gob.redoaxaca.rol.label" default="Rol" /></span>
			...
			<g:form>
				<fieldset class="uk-form-horizontal">
					...
					<g:link class="uk-button" action="edit" id="${rolInstance?.id}"><i class="uk-icon-small uk-icon-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
