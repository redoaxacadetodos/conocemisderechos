		...
		<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="uk-form-horizontal">
					...
					<g:hiddenField name="idTipo" value="${idTipo }"/>
					<g:link class="uk-button" action="edit" id="${categoriaInstance?.id}"><i class="uk-icon-small uk-icon-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
