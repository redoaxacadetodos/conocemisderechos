	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.dependencia}">
				<li class="fieldcontain">
			...
			<g:form>
				<fieldset class="uk-form-horizontal">
					...
					<g:link class="uk-button" action="edit" id="${usuarioInstance?.id}"><i class="uk-icon-small uk-icon-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
