...
<html>
	...
	<body>
		<a href="#edit-unidadEjecutora" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
				<li><g:link class="list" action="list">Listado de unidades ejecutoras</g:link></li>
				<li><g:link class="create" action="create">Nueva unidad ejecutora</g:link></li>
			</ul>
		</div>
		<div id="edit-unidadEjecutora" class="content scaffold-edit" role="main">
			<h1>Edita la unidad ejecutora</h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${unidadEjecutoraInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${unidadEjecutoraInstance}" var="error">
