...
<%--				</g:if>--%>
			...
			<g:form>
				<fieldset class="uk-form-horizontal">
					...
					<g:link class="uk-button" action="edit" id="${ejeInstance?.id}"><i class="uk-icon-small uk-icon-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
					...
					<g:link class="uk-button" controller="division" action="create" params="[ideje:ejeInstance?.id]">Nuevo derecho</g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
