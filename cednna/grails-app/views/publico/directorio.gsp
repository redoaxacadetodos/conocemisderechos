...
<html>
	...
	<body>
		<a href="#list-variable" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
				  ...
				  <g:datatablehelper ctrlid="direcotrioid"  cols="['ID','Nombre','Cargo','Dependencia','Correo','Tel&eacute;fono Oficna','P&aacute;gina WEB']" class="table table-striped table-bordered"></g:datatablehelper>
				  </div>
</body>
